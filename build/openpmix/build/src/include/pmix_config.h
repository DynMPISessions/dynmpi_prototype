...
/* The compiler $lower which PMIx was built with */
#define PMIX_BUILD_PLATFORM_COMPILER_VERSION 525312

/* The compiler $lower which PMIx was built with */
#define PMIX_BUILD_PLATFORM_COMPILER_VERSION_STR 8.4.0

/* OMPI underlying C compiler */
#define PMIX_CC "gcc"

/* Capture the configure cmd line */
#define PMIX_CONFIGURE_CLI " \'--prefix=/dss/dssfs02/lwp-dss-0001/pr63qi/pr63qi-dss-0000/ga84kaf2/shared-folder/install/pmix\' \'--with-hwloc=/dss/dsshome1/lrz/sys/spack/release/21.1.1/opt/haswell/hwloc/2.2.0-gcc-x4ot2a4\' \'--with-libevent=/dss/dssfs02/lwp-dss-0001/pr63qi/pr63qi-dss-0000/ga84kaf2/shared-folder/install/libevent-2.1.12\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Fri Nov 26 11:07:52 UTC 2021"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "cm2login1"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "ga84kaf2"
...
#define PMIX_C_HAVE_BUILTIN_EXPECT 0
...
#define PMIX_ENABLE_MAN_PAGES 0
...
#define PMIX_OFI_PCI_DATA_AVAILABLE 1

/* package/branding string for PMIx */
#define PMIX_PACKAGE_STRING "PMIx ga84kaf2@cm2login1 Distribution"
...
#define PMIX_REPO_REV "v1.1.3-2973-g43d85cc3"
