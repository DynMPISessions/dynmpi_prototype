...
#define PMIX_CONFIGURE_CLI " \'--prefix=/opt/hpc/external/openpmix\' \'--with-hwloc=/opt/hpc/local/hwloc\' \'--with-libevent=/opt/hpc/local/libevent\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Sun Nov 21 16:07:47 UTC 2021"
