...
char H5libhdf5_settings[]=
	...
	"-------------------\n"
	"		   HDF5 Version: 1.8.13\n"
	"		  Configured on: Tue Oct  5 14:46:40 UTC 2021\n"
	"		  Configured by: root@root-node01\n"
	"		 Configure mode: production\n"
	"		    Host system: x86_64-unknown-linux-gnu\n"
	"	      Uname information: Linux root-node01 5.11.0-37-generic #41~20.04.2-Ubuntu SMP Fri Sep 24 09:06:38 UTC 2021 x86_64 x86_64 x86_64 GNU/Linux\n"
	...
	"                    AM_CPPFLAGS: -I/DIR/TO/PTHREAD/include -I/usr/local/include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_BSD_SOURCE \n"
	"               Shared C Library: yes\n"
	"               Static C Library: yes\n"
	"  Statically Linked Executables: no\n"
	"                        LDFLAGS: \n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS:  -L/usr/local/lib -L/DIR/TO/PTHREAD/lib\n"
