...
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 525312
...
/* Pset operation constants. Don't change the order of these */
enum{
   MPI_PSETOP_NULL,
   MPI_PSETOP_UNION, 
...
/* Resource change types. Don't change the order of these */
enum{
   MPI_RC_NULL,
   MPI_RC_ADD, 
   MPI_RC_SUB
...
typedef int ompi_rc_op_type_t;
typedef ompi_rc_op_type_t MPI_RC_TYPE;
...
typedef ompi_rc_status_t MPI_RC_STATUS;
*/
/*
 * MPI API
 */
...
OMPI_DECLSPEC  int MPI_Sendrecv_replace(void * buf, int count, MPI_Datatype datatype,
                                        ...
                                        MPI_Comm comm, MPI_Status *status);
OMPI_DECLSPEC  int MPI_Session_accept_res_change(MPI_Session *session, MPI_Info *info, char delta_pset[], char result_pset[], int root, MPI_Comm *comm, int *terminate);
...
OMPI_DECLSPEC  int MPI_Session_create_errhandler (MPI_Session_errhandler_function *session_errhandler_fn,
                                                  MPI_Errhandler *errhandler);
OMPI_DECLSPEC  int MPI_Session_confirm_res_change(MPI_Session *session, MPI_Info *info, char delta_pset[], char *result_pset[]);
...
OMPI_DECLSPEC  int MPI_Session_get_res_change(MPI_Session session, int *type, char *delta_pset, int *incl, int *status, MPI_Info *info_used);
...
OMPI_DECLSPEC  int MPI_Session_pset_create_op(MPI_Session session, int op, char *pset1, char *pset2, char *pset_result, MPI_Info *info);
OMPI_DECLSPEC  int MPI_Session_request_res_change(MPI_Session session, int delta, char *delta_pset, int rc_type, MPI_Info *info);
